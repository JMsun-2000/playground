...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  3 20:12:42 2020
...
for cnt in range(100):  # 38th is the best one, 97.5% accuracy in test set
    print ("No."+ str(cnt)+ ", Current best is No." + str(best_number))
    ...
    if preds[1] > best:
        best = preds[1]
        best_number = cnt
        model.save('generated_models/best_trained.h5')

# model_json = model.to_json()
# with open("myModelstruct.json", "w") as json_file:
#     json_file.write(model_json)
# # serialize weights to HDF5
# model.save_weights("myModelweight.h5")
# print("Saved model to disk")

# model.save('myWholeModel_tf2_last.h5')


# trained_model = load_model('ResNet50.h5') 
trained_model = load_model('generated_models/best_trained.h5') 
